                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div id="tabela_fornecedores"></div>
                            </div>
                            
                            <div class="table-data__tool">
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i>Adicionar fornecedor
                                    </button>
...
$(document).ready(function(){
	...
	function load_data(query)
        {
            $.ajax({
                url:"funcoes/fornecedores/render_fornecedores.php",
                method:"post",
                data:{query:query},
                success:function(data)
                {
                    // renderizar a tabela e os elementos
                    $('#tabela_fornecedores').html(data); 
                    //
                }
            });
        }
    ...
    $('.au-btn--small').on("click", function(){
       Swal.fire({
                title: 'Digite o nome do novo fornecedor',
                input: 'text',
                ...
                preConfirm: (text) => {
                    ...
                    return fetch('funcoes/fornecedores/fornecedor_cadastro.php', requestOptions)
                    .then(response => {
