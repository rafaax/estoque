                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div id="tabela_categorias"></div>
                            </div>
                            
                            <div class="table-data__tool">
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                        <i class="zmdi zmdi-plus"></i>Adicionar categoria
                                    </button>
...
$(document).ready(function(){
	...
	function load_data(query)
        {
            $.ajax({
                url:"funcoes/categorias/render_categorias.php",
                method:"post",
                data:{query:query},
                success:function(data)
                {
                    // renderizar a tabela e os elementos
                    $('#tabela_categorias').html(data); 
                    //
                }
            });
        }
    ...
    $('.au-btn--small').on("click", function(){
       Swal.fire({
                ...
                preConfirm: (text) => {
                    ...
                    return fetch('funcoes/categorias/categoria_cadastro.php', requestOptions)
                    .then(response => {
