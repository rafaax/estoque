...
<div class="card">
    <div class="card-header">Cadastro de Compra Engeline</div>
    <div class="card-body">
        <form id="form_cadastro" method="post">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="partnumber_produto" class="control-label mb-1">Documento</label>
                        <input id="partnumber_produto" name="partnumber_produto" type="text" class="form-control"
                        aria-required="true" aria-invalid="false" placeholder="Docto" required> 
                    </div>
                </div>
            </div>
            <div class="row">
