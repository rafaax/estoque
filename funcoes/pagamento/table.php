...
<div class="table-responsive table--no-card m-b-30" style="max-height: 500px; overflow-y: auto;">
    <table class="table table-borderless table-striped table-earning">
        ...
        <tbody>
        <?php 
            $sql = "SELECT * from pagamentos order by id asc";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">  
                                <h5 class="modal-title" id="myModalLabel-<?=$id?>">Forma de Pagamento</h5>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-danger btn-delete" onclick="deletaPagamento('<?=$id?>', '<?=$nome?>')">Deletar</button>
                                <button class="btn btn-warning btn-vis-edit" onclick="editaPagamento('<?=$id?>', '<?=$nome?>')">Editar</button>
...
<script>
    ...
    function editaPagamento(id, nome){
        Swal.fire({
                ...
                preConfirm: (text) => {
                    ...
                    return fetch('funcoes/pagamento/editar.php', requestOptions)
                    .then(response => {
    ...
    function deletaPagamento(id, nome){
        Swal.fire
        (
            {
            ...
            if (result.isConfirmed) {
                ...
                return fetch('funcoes/pagamento/deletar.php', requestOptions)
                .then(response => {
                        if (!response.ok) {
                            throw new Error('A solicitação não foi bem-sucedida');
                        }
