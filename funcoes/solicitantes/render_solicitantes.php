...
<div class="table-responsive table--no-card m-b-30" style="max-height: 500px; overflow-y: auto;">
    <table class="table table-borderless table-striped table-earning">
        ...
        <tbody>
        <?php 
            $sql = "SELECT * from integrantes where status = 'Ativo' order by nome asc";
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">  
                                <h5 class="modal-title" id="myModalLabel-<?=$id?>">Solicitante</h5>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-danger btn-delete" onclick="deletaSolicitante('<?=$id?>', '<?=$nome?>')">Desativar</button>
                                <button class="btn btn-warning btn-vis-edit" onclick="editaSolicitante('<?=$id?>', '<?=$nome?>')">Editar</button>
...
<script>
    function editaSolicitante(id, nome){
        Swal.fire({
                ...
                preConfirm: (text) => {
                    ...
                    return fetch('funcoes/solicitantes/solicitante_edit.php', requestOptions)
                    .then(response => {
    ...
    function deletaSolicitante(id, nome){
        Swal.fire
        (
            {
                title: 'Voce deseja desativar o integrante: ' + nome +' ?',
                showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                return fetch('funcoes/solicitantes/solicitante_delete.php', requestOptions)
                .then(response => {
